...
(function (global) {
    ...
    const App = {
        ...
        /* ══ أُعيدت هنا بعد فقدانٍ صامت — ٦ سبتمبر ٢٠٢٦ ══
           سقطت `cacheBanner` و`confirm` و`logout` من هذا الملفّ في الكوميت
           `d479ede` (وموضوعُه تكبيرُ iOS والإشعارات — لا علاقةَ له بها).
           فبقيت النداءاتُ ولم يبقَ المنادى:
             · `logout`  — ثلاثةُ أزرارٍ تناديها، وواحدٌ منها يرمي فيظهر
                            «حدث خطأٌ غير متوقّع» ولا يخرج المعلّم.
             · `confirm` — **‎٢٨‎ نداءً في ‎١٦‎ ملفاً**: حذفُ طالبٍ وتذكيرٍ
                            ومسحُ البيانات وحذفُ الحساب… كلُّها كانت ترمي.
             · `cacheBanner` — يناديها `init` مرّتين عند تعطّل المخزن.
           ولم يكشفها شيء: النداءاتُ في مسارات لا تُختبر إلّا بالضغط. */
