...
(function (global) {
    ...
    function docOptions(extra) {
        return Object.assign({
            ...
            /* ولا تقييمَ نصٍّ برمجيّ: pdf.js تبني بعضَ مفكّكات الصور
               بـ`new Function` حين تراه مسموحاً، ووسمُ CSP في `index.html`
               لا يمنح `'unsafe-eval'` — فتقع المحاولةُ في الاعتراض ويُلقى
               تحذيرٌ في السجلّ عند كلّ ملفّ. وإطفاؤه صراحةً يجعلها تسلك
               المسارَ البديل من أوّل الأمر: لا تحذيرَ ولا محاولةٌ فاشلة،
               والفارقُ في السرعة لا يُلحَظ في كتابٍ يُقرأ صفحةً صفحة. */
