    ...
    function buildDoc(ctx) {
        ...
        if (t.attTotal) {
            out.push(sec('تفصيل الحضور', `<div class="rpp-card">${meters(ATT.map((g) => ({
                ...
                /* ══ شَرطةٌ لا نقطةٌ بين رقمين ══
                   الفاصلُ كان ‎' · '‎، و‎`·`‎ و‎`٠`‎ **رسمُهما واحدٌ** في الأرقام
                   العربيّة. فـ«‎٩٠٪ · ٦٤٦‎» تُقرأ على الجهاز «‎%٩· · ٦٤٦‎» —
                   نقطتان متجاورتان إحداهما رقمٌ والأخرى فاصل، فلا يُعرف أين
                   ينتهي العددُ وأين يبدأ الآخر. (قِيس بحجمه الحقيقيّ على
                   iPhone 17 Pro Max، ١٥ سبتمبر ٢٠٢٦، ببياناتٍ حقيقيّة —
                   ولا يظهر بالأرقام اللاتينيّة أصلاً لأنّ صفرَها بيضويّ.)
                   والنقطةُ تبقى حيث يسبقها حرفٌ («العلوم · ٢٦ طالباً»). */
