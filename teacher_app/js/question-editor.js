...
(function (global) {
    ...
    function bind(root, qs, o) {
        ...
        /* الفقرةُ الجديدةُ تُعرَض ولا تُركَّز: تُمرَّر إلى وسط الشاشة، وتبقى
           لوحةُ المفاتيح مغلقةً حتى يلمس المعلّمُ المربّعَ بنفسه.

           وكانت تُركَّز فتنفتح اللوحةُ فوراً، فطلب رفعَها: يريد أن يرى ما
           أضافه قبل أن يكتب فيه — وربّما أضاف فقرتين ثمّ عاد إلى الأولى.
           ولوحةٌ تقفز مع كلِّ إضافةٍ تحجب نصفَ الشاشة على من لا يريد
           الكتابةَ الآن. (طلبُ المعلّم ٢٩ أغسطس ٢٠٢٦.) */
        const revealItem = (at) => {
