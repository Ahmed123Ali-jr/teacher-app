...
(function (global) {
    ...
    function bind(root, qs, o) {
        ...
        /* بعد الإضافة: المؤشّرُ في الفقرة الجديدة ولوحةُ المفاتيح مفتوحة —
           فالمعلّم أضافها ليكتبها، لا لينزل إليها بإصبعه ثمّ يلمسها.

           وبلا `preventScroll` وبلا `scrollIntoView` بعدَها: iOS لا يفتح
           لوحةَ المفاتيح على تركيزٍ برمجيٍّ إلّا داخل إيماءةٍ ومعها تمريرُه
           هو إلى الخانة. فمنعُ تمريره ثمّ تمريرُنا نحن مكانَه يقطع ما يربط
           التركيزَ باللوحة، فتُفتح الخانةُ بلا لوحة. والنظامُ — كلُّ نظام —
           يمرّر إلى الخانة المركَّزة من نفسه. (بلاغُ المعلّم ٢٩ أغسطس.) */
        const focusItem = (at) => {
