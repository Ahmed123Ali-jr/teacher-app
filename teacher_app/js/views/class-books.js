...
(function (global) {
    ...
    async function render(panel, cls) {
        ...
        /* التحذيرُ حيث يُفيد: تحت كتبٍ موجودةٍ يُخشى عليها، لا في الحالة
           الفارغة حيث لا شيءَ يُفقد بعد. والملفّاتُ محليّةٌ بقرار المستخدم
           (٢١ أغسطس) — فحقُّه أن يعلم قبل أن يعتمد عليها. */
        panel.innerHTML = `
