...
(function (global) {
    ...
    function restCardHtml(kind, off) {
        if (kind === 'weekend') {
            /* ══ تحيّةُ نهاية الأسبوع ══
               «إجازة سعيدة» كانت ‎21px‎ بوزن ‎700‎، فقال (٣ سبتمبر ٢٠٢٦):
               «أحسّ الخطّ عريضٌ جدّاً». والمقولاتُ الأثريّةُ عُرضت وسقطت
               بقوله «لا تعتمد» — فبقيت الجملةُ وحدَها، أطولَ وأدفأ:
               «إجازة نهاية أسبوع سعيدة».

               والخطُّ خطُّ التطبيق نفسُه (اختار «أ» من ثلاثةٍ عُرضت عليه،
               وفيها نسخيُّ آبل ودمشق) — وزنُه ‎500‎ لا ‎700‎ وحجمُه ‎19px‎
               لا ‎21‎. والأرضيّةُ ذهبيّةٌ منقولةٌ حرفاً بحرف من لافتة «لا
               يوجد لديك فصول»: خلطةٌ واحدةٌ وحدٌّ واحدٌ ونصفُ قطرٍ واحد،
               فلا ذهبيّان مختلفان في تطبيقٍ واحد. */
            return `
                <div class="home-hero-alt is-weekend">
                    <div class="ha-t">إجازة نهاية أسبوع سعيدة</div>
