            ...
            function bindPreview() {
                ...
                resultEl.querySelector('#imp-apply').addEventListener('click', async (e) => {
                    ...
                    try {
                        ...
                        /* والاعتمادُ يُنهي التعديل. الشاشةُ دخلت وضعَ التعديل
                           لأنّ المعلّم جاء من «ارفع جدولك» — وذلك لمن أغلق
                           الاستيراد وأراد الكتابةَ بيده، لا لمن اعتمد. فكان
                           يعتمد فيجد جدولَه مرسوماً و«✓ تمّ» ما زالت قائمة،
                           فيضغطها ثانيةً بلا معنى. بلاغُه (٤ سبتمبر ٢٠٢٦):
                           «المفروض أوّل ما أضغط اعتمد يعتمد بدون يبقى
                           التعديل شغّال». */
                        ctx.editing = false;
