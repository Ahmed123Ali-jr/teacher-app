...
/* ==========================================================================
   ...
   **لا يقول إن كان الرقمُ صحيحاً.** لو كُتب `9.9.9` في الأربعة رضي.
   ...
   ── ومصدرٌ رابعٌ سقط ──
   كان يُقارَن معها **رأسُ `CHANGELOG`** في `settings.js`. وقد حُذف سجلُّ
   التحديثات من «عن التطبيق» بقراره (٦ سبتمبر ٢٠٢٦)، فسقط المصدرُ معه.
   وأمسكه الحارسُ نفسُه عند الحذف — وهو المقصود منه.
